  ...
  const rows = [
    {
      ...
      customer: "Hosny Aroui",
      date: "1 Mars",
      amount: 785,
      method: "Paiement en livraison",
      status: "Enattente",
    },
    {
      id: 2235235,
  ...
  return (
    <TableContainer component={Paper} className="table">
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell className="tableCell">Numéro commande</TableCell>
